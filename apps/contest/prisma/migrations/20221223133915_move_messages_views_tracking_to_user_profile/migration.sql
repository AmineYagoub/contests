/*
  ...
  - You are about to drop the column `sendToAll` on the `Message` table. All the data in the column will be lost.
  - You are about to drop the column `viewers` on the `Message` table. All the data in the column will be lost.
  - Added the required column `recipients` to the `Message` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `Message` DROP COLUMN `sendToAll`,
    DROP COLUMN `viewers`,
    ADD COLUMN `recipients` JSON NOT NULL;
