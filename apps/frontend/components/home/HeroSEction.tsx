  ...
  return (
    <StyledContainer>
      <Col span={14}>
        ...
        <StyledParagraph>
          تقدِّم منصَّة أولمبياد النَّحو العربيِّ العديد من المسابقات والجوائز
          لجميع الأعمار ابتداءً من الصَّفِّ السَّادس الابتدائيِّ (مستوى 12 سنةً
          ) إلى الصَّفِّ الثَّالث الثَّانويِّ (مستوى 18 سنة ).
        </StyledParagraph>
